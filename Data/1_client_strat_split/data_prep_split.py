...
# -------------------- MAKE 1 CLIENT (ALL DATA) + STRATIFIED TRAIN/VAL SPLIT --------------------
...
# One "client_0" that includes all patients
meta_c = meta.reset_index(drop=True)
Xc = meta_c["pid"].values

# Try to use the finest available stratification level for train/val
...
# Save the single client's splits
