...
def run_one_experiment(model_name: str, encoder_name: str, num_rounds=5, local_epochs=5, lr=1e-3, mu=0.01):
    ...
    strategy = PerClientLoggingFedAvg(
        ...
        on_fit_config_fn=lambda rnd: {"local_epochs": local_epochs, "lr": lr, "mu": 0.01},
    )
...
if __name__ == "__main__":
    ...
    for model_name, encoder_name in experiments:
        ...
        run_one_experiment(model_name, encoder_name, num_rounds=5, local_epochs=5, lr=1e-3, mu=0.01)
